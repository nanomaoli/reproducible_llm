...
if __name__ == '__main__':
    ...
    for batch_start in range(start_point, total_samples, args.batch_size):
        ...
        for idx, output in enumerate(response):
            ...
            # save all k samples' logits
            torch.save(all_token_ids, f'{output_path}/problem_{global_idx}_{args.task}_token_ids_bs_{args.batch_size}_{args.dtype}_max_tokens_{args.max_tokens}_pass{args.passk}.pt')
            torch.save(all_logprobs, f'{output_path}/problem_{global_idx}_{args.task}_logprobs_bs_{args.batch_size}_{args.dtype}_max_tokens_{args.max_tokens}_pass{args.passk}.pt')
